    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pairedDeviceListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(ActivityMain.this, "onItemClick: "+ deviceName + " with MAC:" + deviceAddress, Toast.LENGTH_SHORT).show();

                // Navigate to new Screen by passing deviceAddress for connection purpose later.
                Intent newScreenIntent = new Intent(ActivityMain.this, ActivityControl.class);
        ...
        newDeviceListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN_MR2){
                    Toast.makeText(ActivityMain.this, "Trying to pair with "+deviceName, Toast.LENGTH_SHORT).show();
